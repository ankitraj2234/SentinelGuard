...
import com.sentinelguard.di.AlertModule_ProvideEmailAlertServiceFactory;
...
import com.sentinelguard.di.DatabaseModule_ProvideAlertHistoryDaoFactory;
...
import com.sentinelguard.di.DatabaseModule_ProvideCellTowerDaoFactory;
...
import com.sentinelguard.scanner.NetworkSecurityScanner;
import com.sentinelguard.scanner.PrivacyScanner;
import com.sentinelguard.scanner.SystemIntegrityScanner;
...
import com.sentinelguard.ui.MainActivity_MembersInjector;
...
import com.sentinelguard.ui.viewmodels.CellTowerDetailsViewModel_HiltModules;
...
import com.sentinelguard.ui.viewmodels.ForensicReportViewModel_HiltModules;
...
import com.sentinelguard.ui.viewmodels.NetworkInfoViewModel_HiltModules;
...
import com.sentinelguard.ui.viewmodels.UsageStatisticsViewModel_HiltModules;
...
public final class DaggerSentinelGuardApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends SentinelGuardApp_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(13).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_CellTowerDetailsViewModel, CellTowerDetailsViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_DashboardViewModel, DashboardViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_ForensicReportViewModel, ForensicReportViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_LoginViewModel, LoginViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_MainViewModel, MainViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_NetworkInfoViewModel, NetworkInfoViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_PasswordRecoveryViewModel, PasswordRecoveryViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_sentinelguard_ui_screens_PermissionViewModel, PermissionViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_ScanViewModel, ScanViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_SettingsViewModel, SettingsViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_SetupViewModel, SetupViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_TimelineViewModel, TimelineViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_UsageStatisticsViewModel, UsageStatisticsViewModel_HiltModules.KeyModule.provide()).build());
    }
    ...
    private MainActivity injectMainActivity2(MainActivity instance) {
      MainActivity_MembersInjector.injectBiometricAuthManager(instance, singletonCImpl.provideBiometricAuthManagerProvider.get());
      MainActivity_MembersInjector.injectSecurePrefs(instance, singletonCImpl.provideSecurePreferencesManagerProvider.get());
      return instance;
    }

    @IdentifierNameString
    private static final class LazyClassKeyProvider {
      static String com_sentinelguard_ui_viewmodels_ForensicReportViewModel = "com.sentinelguard.ui.viewmodels.ForensicReportViewModel";
      ...
      static String com_sentinelguard_ui_viewmodels_NetworkInfoViewModel = "com.sentinelguard.ui.viewmodels.NetworkInfoViewModel";
      ...
      static String com_sentinelguard_ui_viewmodels_CellTowerDetailsViewModel = "com.sentinelguard.ui.viewmodels.CellTowerDetailsViewModel";

      static String com_sentinelguard_ui_viewmodels_UsageStatisticsViewModel = "com.sentinelguard.ui.viewmodels.UsageStatisticsViewModel";

      static String com_sentinelguard_ui_viewmodels_LoginViewModel = "com.sentinelguard.ui.viewmodels.LoginViewModel";

      @KeepFieldType
      ForensicReportViewModel com_sentinelguard_ui_viewmodels_ForensicReportViewModel2;
      ...
      @KeepFieldType
      NetworkInfoViewModel com_sentinelguard_ui_viewmodels_NetworkInfoViewModel2;
      ...
      @KeepFieldType
      CellTowerDetailsViewModel com_sentinelguard_ui_viewmodels_CellTowerDetailsViewModel2;

      @KeepFieldType
      UsageStatisticsViewModel com_sentinelguard_ui_viewmodels_UsageStatisticsViewModel2;
  ...
  private static final class ViewModelCImpl extends SentinelGuardApp_HiltComponents.ViewModelC {
    ...
    private Provider<CellTowerDetailsViewModel> cellTowerDetailsViewModelProvider;

    private Provider<DashboardViewModel> dashboardViewModelProvider;

    private Provider<ForensicReportViewModel> forensicReportViewModelProvider;
    ...
    private Provider<UsageStatisticsViewModel> usageStatisticsViewModelProvider;
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.cellTowerDetailsViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
      this.dashboardViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
      this.forensicReportViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 2);
      ...
      this.networkInfoViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 5);
      this.passwordRecoveryViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 6);
      this.permissionViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 7);
      this.scanViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 8);
      ...
      this.usageStatisticsViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 12);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(13).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_CellTowerDetailsViewModel, ((Provider) cellTowerDetailsViewModelProvider)).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_DashboardViewModel, ((Provider) dashboardViewModelProvider)).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_ForensicReportViewModel, ((Provider) forensicReportViewModelProvider)).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_LoginViewModel, ((Provider) loginViewModelProvider)).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_MainViewModel, ((Provider) mainViewModelProvider)).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_NetworkInfoViewModel, ((Provider) networkInfoViewModelProvider)).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_PasswordRecoveryViewModel, ((Provider) passwordRecoveryViewModelProvider)).put(LazyClassKeyProvider.com_sentinelguard_ui_screens_PermissionViewModel, ((Provider) permissionViewModelProvider)).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_ScanViewModel, ((Provider) scanViewModelProvider)).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_SettingsViewModel, ((Provider) settingsViewModelProvider)).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_SetupViewModel, ((Provider) setupViewModelProvider)).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_TimelineViewModel, ((Provider) timelineViewModelProvider)).put(LazyClassKeyProvider.com_sentinelguard_ui_viewmodels_UsageStatisticsViewModel, ((Provider) usageStatisticsViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.sentinelguard.ui.viewmodels.CellTowerDetailsViewModel 
          return (T) new CellTowerDetailsViewModel(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.cellTowerLookupServiceProvider.get(), singletonCImpl.cellTowerSecurityMonitorProvider.get(), singletonCImpl.cellTowerDao());

          case 1: // com.sentinelguard.ui.viewmodels.DashboardViewModel 
          return (T) new DashboardViewModel(singletonCImpl.riskScoringEngineProvider.get(), singletonCImpl.provideBaselineEngineProvider.get(), singletonCImpl.provideSecurePreferencesManagerProvider.get(), singletonCImpl.networkInfoManagerProvider.get());

          case 2: // com.sentinelguard.ui.viewmodels.ForensicReportViewModel 
          return (T) new ForensicReportViewModel(singletonCImpl.forensicReportGeneratorProvider.get(), singletonCImpl.emailServiceProvider.get(), singletonCImpl.provideSecurePreferencesManagerProvider.get());

          case 3: // com.sentinelguard.ui.viewmodels.LoginViewModel 
          ...
          case 4: // com.sentinelguard.ui.viewmodels.MainViewModel 
          ...
          case 5: // com.sentinelguard.ui.viewmodels.NetworkInfoViewModel 
          return (T) new NetworkInfoViewModel(singletonCImpl.networkInfoManagerProvider.get());

          case 6: // com.sentinelguard.ui.viewmodels.PasswordRecoveryViewModel 
          ...
          case 7: // com.sentinelguard.ui.screens.PermissionViewModel 
          return (T) new PermissionViewModel(singletonCImpl.permissionManagerProvider.get());

          case 8: // com.sentinelguard.ui.viewmodels.ScanViewModel 
          return (T) new ScanViewModel(singletonCImpl.malwareScannerProvider.get(), singletonCImpl.deepScanEngineProvider.get(), singletonCImpl.fileSystemScannerProvider.get(), singletonCImpl.provideSecurePreferencesProvider.get());

          case 9: // com.sentinelguard.ui.viewmodels.SettingsViewModel 
          return (T) new SettingsViewModel(singletonCImpl.provideSecurePreferencesProvider.get(), singletonCImpl.provideSecurePreferencesManagerProvider.get(), singletonCImpl.provideUserRepositoryProvider.get(), singletonCImpl.settingsBackupManagerProvider.get());

          case 10: // com.sentinelguard.ui.viewmodels.SetupViewModel 
          ...
          case 11: // com.sentinelguard.ui.viewmodels.TimelineViewModel 
          return (T) new TimelineViewModel(singletonCImpl.provideTimelineBuilderProvider.get());

          case 12: // com.sentinelguard.ui.viewmodels.UsageStatisticsViewModel 
          return (T) new UsageStatisticsViewModel(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.appUsageTrackerProvider.get(), singletonCImpl.permissionManagerProvider.get());
  ...
  private static final class SingletonCImpl extends SentinelGuardApp_HiltComponents.SingletonC {
    ...
    private Provider<RateLimiter> rateLimiterProvider;

    private Provider<CellTowerLookupService> cellTowerLookupServiceProvider;

    private Provider<DatabasePassphraseManager> provideDatabasePassphraseManagerProvider;

    private Provider<AppDatabase> provideAppDatabaseProvider;

    private Provider<EmailAlertService> provideEmailAlertServiceProvider;

    private Provider<CellTowerSecurityMonitor> cellTowerSecurityMonitorProvider;
    ...
    private Provider<NetworkInfoManager> networkInfoManagerProvider;

    private Provider<IntruderCaptureService> intruderCaptureServiceProvider;

    private Provider<SecurityAlertManager> securityAlertManagerProvider;

    private Provider<ForensicReportGenerator> forensicReportGeneratorProvider;
    ...
    private Provider<FileSystemScanner> fileSystemScannerProvider;

    private Provider<SystemIntegrityScanner> systemIntegrityScannerProvider;

    private Provider<NetworkSecurityScanner> networkSecurityScannerProvider;

    private Provider<PrivacyScanner> privacyScannerProvider;

    private Provider<DeepScanEngine> deepScanEngineProvider;

    private Provider<UserRepository> provideUserRepositoryProvider;

    private Provider<SettingsBackupManager> settingsBackupManagerProvider;
    ...
    private CellTowerDao cellTowerDao() {
      return DatabaseModule_ProvideCellTowerDaoFactory.provideCellTowerDao(provideAppDatabaseProvider.get());
    }

    private AlertHistoryDao alertHistoryDao() {
      return DatabaseModule_ProvideAlertHistoryDaoFactory.provideAlertHistoryDao(provideAppDatabaseProvider.get());
    }
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.crashHandlerProvider = DoubleCheck.provider(new SwitchingProvider<CrashHandler>(singletonCImpl, 2));
      this.provideBiometricAuthManagerProvider = DoubleCheck.provider(new SwitchingProvider<BiometricAuthManager>(singletonCImpl, 3));
      this.provideSecurePreferencesManagerProvider = DoubleCheck.provider(new SwitchingProvider<SecurePreferencesManager>(singletonCImpl, 4));
      this.provideSecurePreferencesProvider = DoubleCheck.provider(new SwitchingProvider<SecurePreferences>(singletonCImpl, 6));
      this.rateLimiterProvider = DoubleCheck.provider(new SwitchingProvider<RateLimiter>(singletonCImpl, 7));
      this.cellTowerLookupServiceProvider = DoubleCheck.provider(new SwitchingProvider<CellTowerLookupService>(singletonCImpl, 5));
      this.provideDatabasePassphraseManagerProvider = DoubleCheck.provider(new SwitchingProvider<DatabasePassphraseManager>(singletonCImpl, 10));
      this.provideAppDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<AppDatabase>(singletonCImpl, 9));
      this.provideEmailAlertServiceProvider = DoubleCheck.provider(new SwitchingProvider<EmailAlertService>(singletonCImpl, 11));
      this.cellTowerSecurityMonitorProvider = DoubleCheck.provider(new SwitchingProvider<CellTowerSecurityMonitor>(singletonCImpl, 8));
      this.provideRiskScoreRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<RiskScoreRepository>(singletonCImpl, 13));
      this.provideSecuritySignalRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<SecuritySignalRepository>(singletonCImpl, 14));
      this.provideBaselineRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<BaselineRepository>(singletonCImpl, 16));
      this.provideBaselineEngineProvider = DoubleCheck.provider(new SwitchingProvider<BaselineEngine>(singletonCImpl, 15));
      this.permissionManagerProvider = DoubleCheck.provider(new SwitchingProvider<PermissionManager>(singletonCImpl, 19));
      this.appUsageTrackerProvider = DoubleCheck.provider(new SwitchingProvider<AppUsageTracker>(singletonCImpl, 18));
      this.appUsagePatternAnalyzerProvider = DoubleCheck.provider(new SwitchingProvider<AppUsagePatternAnalyzer>(singletonCImpl, 17));
      this.provideFusedLocationClientProvider = DoubleCheck.provider(new SwitchingProvider<FusedLocationProviderClient>(singletonCImpl, 21));
      this.locationClusterManagerProvider = DoubleCheck.provider(new SwitchingProvider<LocationClusterManager>(singletonCImpl, 20));
      this.networkBehaviorTrackerProvider = DoubleCheck.provider(new SwitchingProvider<NetworkBehaviorTracker>(singletonCImpl, 22));
      this.unlockPatternAnalyzerProvider = DoubleCheck.provider(new SwitchingProvider<UnlockPatternAnalyzer>(singletonCImpl, 23));
      this.riskScoringEngineProvider = DoubleCheck.provider(new SwitchingProvider<RiskScoringEngine>(singletonCImpl, 12));
      this.networkInfoManagerProvider = DoubleCheck.provider(new SwitchingProvider<NetworkInfoManager>(singletonCImpl, 24));
      this.intruderCaptureServiceProvider = DoubleCheck.provider(new SwitchingProvider<IntruderCaptureService>(singletonCImpl, 27));
      this.securityAlertManagerProvider = DoubleCheck.provider(new SwitchingProvider<SecurityAlertManager>(singletonCImpl, 26));
      this.forensicReportGeneratorProvider = DoubleCheck.provider(new SwitchingProvider<ForensicReportGenerator>(singletonCImpl, 25));
      this.provideAuthRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<AuthRepository>(singletonCImpl, 28));
      this.provideSignalCollectorProvider = DoubleCheck.provider(new SwitchingProvider<SignalCollector>(singletonCImpl, 29));
      this.malwareScannerProvider = DoubleCheck.provider(new SwitchingProvider<MalwareScanner>(singletonCImpl, 30));
      this.fileSystemScannerProvider = DoubleCheck.provider(new SwitchingProvider<FileSystemScanner>(singletonCImpl, 32));
      this.systemIntegrityScannerProvider = DoubleCheck.provider(new SwitchingProvider<SystemIntegrityScanner>(singletonCImpl, 33));
      this.networkSecurityScannerProvider = DoubleCheck.provider(new SwitchingProvider<NetworkSecurityScanner>(singletonCImpl, 34));
      this.privacyScannerProvider = DoubleCheck.provider(new SwitchingProvider<PrivacyScanner>(singletonCImpl, 35));
      this.deepScanEngineProvider = DoubleCheck.provider(new SwitchingProvider<DeepScanEngine>(singletonCImpl, 31));
      this.provideUserRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<UserRepository>(singletonCImpl, 36));
      this.settingsBackupManagerProvider = DoubleCheck.provider(new SwitchingProvider<SettingsBackupManager>(singletonCImpl, 37));
      this.provideIncidentRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<IncidentRepository>(singletonCImpl, 39));
      this.provideTimelineBuilderProvider = DoubleCheck.provider(new SwitchingProvider<TimelineBuilder>(singletonCImpl, 38));
    }
    ...
    private SentinelGuardApp injectSentinelGuardApp2(SentinelGuardApp instance) {
      ...
      SentinelGuardApp_MembersInjector.injectCrashHandler(instance, crashHandlerProvider.get());
      return instance;
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 2: // com.sentinelguard.crash.CrashHandler 
          return (T) new CrashHandler(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 3: // com.sentinelguard.auth.BiometricAuthManager 
          ...
          case 4: // com.sentinelguard.data.preferences.SecurePreferencesManager 
          ...
          case 5: // com.sentinelguard.network.CellTowerLookupService 
          return (T) new CellTowerLookupService(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.provideSecurePreferencesProvider.get(), singletonCImpl.rateLimiterProvider.get());

          case 6: // com.sentinelguard.data.local.preferences.SecurePreferences 
          ...
          case 7: // com.sentinelguard.security.ratelimit.RateLimiter 
          return (T) new RateLimiter();

          case 8: // com.sentinelguard.security.CellTowerSecurityMonitor 
          return (T) new CellTowerSecurityMonitor(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.cellTowerLookupServiceProvider.get(), singletonCImpl.cellTowerDao(), singletonCImpl.provideEmailAlertServiceProvider.get());

          case 9: // com.sentinelguard.data.database.AppDatabase 
          ...
          case 10: // com.sentinelguard.data.database.DatabasePassphraseManager 
          ...
          case 11: // com.sentinelguard.alert.EmailAlertService 
          return (T) AlertModule_ProvideEmailAlertServiceFactory.provideEmailAlertService(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.alertHistoryDao());

          case 12: // com.sentinelguard.security.risk.RiskScoringEngine 
          ...
          case 13: // com.sentinelguard.domain.repository.RiskScoreRepository 
          return (T) DatabaseModule_ProvideRiskScoreRepositoryFactory.provideRiskScoreRepository(singletonCImpl.riskScoreDao());

          case 14: // com.sentinelguard.domain.repository.SecuritySignalRepository 
          ...
          case 15: // com.sentinelguard.security.baseline.BaselineEngine 
          ...
          case 16: // com.sentinelguard.domain.repository.BaselineRepository 
          return (T) DatabaseModule_ProvideBaselineRepositoryFactory.provideBaselineRepository(singletonCImpl.behavioralBaselineDao());

          case 17: // com.sentinelguard.security.baseline.AppUsagePatternAnalyzer 
          ...
          case 18: // com.sentinelguard.security.collector.AppUsageTracker 
          ...
          case 19: // com.sentinelguard.permission.PermissionManager 
          ...
          case 20: // com.sentinelguard.security.baseline.LocationClusterManager 
          ...
          case 21: // com.google.android.gms.location.FusedLocationProviderClient 
          ...
          case 22: // com.sentinelguard.security.collector.NetworkBehaviorTracker 
          ...
          case 23: // com.sentinelguard.security.baseline.UnlockPatternAnalyzer 
          ...
          case 24: // com.sentinelguard.network.NetworkInfoManager 
          return (T) new NetworkInfoManager(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 25: // com.sentinelguard.report.ForensicReportGenerator 
          return (T) new ForensicReportGenerator(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.cellTowerDao(), singletonCImpl.provideSecurePreferencesProvider.get(), singletonCImpl.appUsageTrackerProvider.get(), singletonCImpl.securityAlertManagerProvider.get());

          case 26: // com.sentinelguard.security.alert.SecurityAlertManager 
          return (T) new SecurityAlertManager(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.emailServiceProvider.get(), singletonCImpl.provideSecurePreferencesProvider.get(), singletonCImpl.intruderCaptureServiceProvider.get());

          case 27: // com.sentinelguard.security.intruder.IntruderCaptureService 
          return (T) new IntruderCaptureService(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.emailServiceProvider.get(), singletonCImpl.provideSecurePreferencesProvider.get());

          case 28: // com.sentinelguard.auth.AuthRepository 
          ...
          case 29: // com.sentinelguard.security.collector.SignalCollector 
          ...
          case 30: // com.sentinelguard.scanner.MalwareScanner 
          ...
          case 31: // com.sentinelguard.scanner.DeepScanEngine 
          return (T) new DeepScanEngine(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.malwareScannerProvider.get(), singletonCImpl.fileSystemScannerProvider.get(), singletonCImpl.systemIntegrityScannerProvider.get(), singletonCImpl.networkSecurityScannerProvider.get(), singletonCImpl.privacyScannerProvider.get());

          case 32: // com.sentinelguard.scanner.FileSystemScanner 
          return (T) new FileSystemScanner(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 33: // com.sentinelguard.scanner.SystemIntegrityScanner 
          return (T) new SystemIntegrityScanner(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 34: // com.sentinelguard.scanner.NetworkSecurityScanner 
          return (T) new NetworkSecurityScanner(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 35: // com.sentinelguard.scanner.PrivacyScanner 
          return (T) new PrivacyScanner(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 36: // com.sentinelguard.domain.repository.UserRepository 
          ...
          case 37: // com.sentinelguard.backup.SettingsBackupManager 
          return (T) new SettingsBackupManager(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.provideSecurePreferencesProvider.get());

          case 38: // com.sentinelguard.incident.TimelineBuilder 
          ...
          case 39: // com.sentinelguard.domain.repository.IncidentRepository 
